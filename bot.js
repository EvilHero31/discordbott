...
exports.start = function (SETUP) {
  const URL_SERVER = "http://167.172.180.203:30120");

  const URL_PLAYERS = new URL("/players.json", "http://167.172.180.203:30120").toString();
  const URL_INFO = new URL("/info.json", "http://167.172.180.203:30120").toString();
  ...
  const UpdateEmbed = function () {
    ...
    let embed = new Discord.RichEmbed()
      ...
      .addField(
        ...
        "Vă puteți alătura serverului scriind ***connect lsrp.join-game.net*** in consola F8 din FiveM. În partea de jos este statusul serverului pentru a vedea câte persoane sunt online și în coadă.\n\u200b\n"
      );
    if (STATUS !== undefined) {
