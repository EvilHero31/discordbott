  ...
  const UpdateEmbed = function () {
    ...
    let embed = new Discord.RichEmbed()
      ...
      .addField(
        ...
        "Vă puteți alătura serverului scriind connect ***cfx.re/join/kq7axv*** in consola F8 din FiveM. În partea de jos este statusul serverului pentru a vedea câte persoane sunt online și în coadă.\n\u200b\n"
      );
    if (STATUS !== undefined) {
